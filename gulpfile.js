...
gulp.task("copy", function() {
  ...
  gulp.src("js/vendor/firebase-app.js").pipe(gulp.dest("dist"));
  gulp.src("js/vendor/firebase-auth.js").pipe(gulp.dest("dist"));
  gulp.src("js/vendor/firebase-database.js").pipe(gulp.dest("dist"));
  gulp.src("js/vendor/firebaseInitialization.js").pipe(gulp.dest("dist"));
